    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#7B8190] mt-2 text-sm transition-colors">Sign in to continue to your dashboard</p>
        </div>
        ...
        <p className="text-[#7B8190] text-sm text-center mt-8 transition-colors">
          ...
          <Link to="/signup" className="text-[#48684F] font-medium hover:text-[#3F5D45] transition-colors">
            Create one now
          </Link>
        </p>
      </form>
